    ...
    return (
        <div>
            ...
            <form className="flex flex-col justify-center items-start gap-3 w-fit mx-auto shadow-2xl p-10 px-20 rounded-md m-20">
                <h2 className="text-xl font-semibold"><span className="text-lime-500">Signup</span> to Fintook</h2>
                <input type="text" className="border border-gray-300 p-2 rounded-md" placeholder="Name" />
                <input type="email" className="border border-gray-300 p-2 rounded-md" placeholder="Email" />
                <input type="number" className="border border-gray-300 p-2 rounded-md" placeholder="Phone" />
                <input type="password" className="border border-gray-300 p-2 rounded-md" placeholder="Passoword" />
                <button className="px-5 py-2 bg-lime-500 rounded-md">Sign up</button>
                <Link href="/login" className="text-sm text-gray-500">Already have an account</Link>
            </form>
        </div>
    )
}